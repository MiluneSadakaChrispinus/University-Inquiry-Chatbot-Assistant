...
# Add the placeholder text back after sending the message
    user_input.insert("1.0", 'Type your message here...')
    user_input.config(fg='grey')

    # Check that the message is not empty and not the placeholder text
